...
function Plan({ name, price, description, href, features, featured = false, billingPeriod = 'monthly' }) {
  const displayPrice = billingPeriod === 'annually' ? price.annually : price.monthly
  
  return (
    <section
      className={clsx(
        'flex flex-col rounded-3xl px-6 sm:px-8',
        featured ? 'order-first bg-indigo-600 py-8 lg:order-0' : 'lg:py-8',
      )}
    >
...
const tiers = [
  {
    ...
    features: [
      ...
      'SMS integration for customers and partners',
    ],
    mostPopular: false,
  },
  {
        ...
        <div className="md:text-center">
          ...
          <div className="mt-8 flex justify-center">
            <div className="bg-slate-800 p-1 rounded-lg">
              ...
              >
                Annual
                <span className="ml-1 text-xs text-indigo-200">Save 10%</span>
              </button>
            </div>
          </div>
          
          {/* Price Note */}
          <p className="mt-10 text-sm font-medium text-slate-400 text-center">
            {tiers[0].price.note}
          </p>
        </div>
